try{
(()=>{var S=__STORYBOOK_API__,{ActiveTabs:v,Consumer:T,ManagerContext:E,Provider:w,addons:n,combineParameters:k,controlOrMetaKey:O,controlOrMetaSymbol:B,eventMatchesShortcut:R,eventToShortcut:I,isMacLike:A,isShortcutTaken:M,keyToSymbol:P,merge:H,mockChannel:V,optionOrAltSymbol:F,shortcutMatchesShortcut:L,shortcutToHumanString:G,types:N,useAddonState:Y,useArgTypes:j,useArgs:z,useChannel:D,useGlobalTypes:K,useGlobals:U,useParameter:W,useSharedState:$,useStoryPrepared:Z,useStorybookApi:q,useStorybookState:J}=__STORYBOOK_API__;var se=__STORYBOOK_THEMING__,{CacheProvider:oe,ClassNames:re,Global:ae,ThemeProvider:ne,background:ie,color:le,convert:ce,create:i,createCache:de,createGlobal:pe,createReset:fe,css:me,darken:ue,ensure:ge,ignoreSsrWarning:ye,isPropValid:Ce,jsx:_e,keyframes:he,lighten:xe,styled:be,themes:Se,typography:ve,useTheme:Te,withTheme:Ee}=__STORYBOOK_THEMING__;var l="3.1.6";var c=i({base:"light",brandTitle:` <div style="display: flex; align-items: center;">
    <svg
      width="36"
      height="45"
      viewBox="0 0 36 45"
