try{
(()=>{var S=__STORYBOOK_API__,{ActiveTabs:v,Consumer:T,ManagerContext:k,Provider:E,addons:n,combineParameters:w,controlOrMetaKey:O,controlOrMetaSymbol:B,eventMatchesShortcut:R,eventToShortcut:I,isMacLike:A,isShortcutTaken:M,keyToSymbol:P,merge:H,mockChannel:V,optionOrAltSymbol:F,shortcutMatchesShortcut:L,shortcutToHumanString:G,types:N,useAddonState:W,useArgTypes:Y,useArgs:j,useChannel:z,useGlobalTypes:D,useGlobals:K,useParameter:U,useSharedState:$,useStoryPrepared:Z,useStorybookApi:q,useStorybookState:J}=__STORYBOOK_API__;var se=__STORYBOOK_THEMING__,{CacheProvider:oe,ClassNames:re,Global:ae,ThemeProvider:ne,background:ie,color:le,convert:ce,create:i,createCache:de,createGlobal:pe,createReset:fe,css:me,darken:ue,ensure:ge,ignoreSsrWarning:ye,isPropValid:Ce,jsx:_e,keyframes:he,lighten:be,styled:xe,themes:Se,typography:ve,useTheme:Te,withTheme:ke}=__STORYBOOK_THEMING__;var l="4.4.0-beta.0";var c=i({base:"light",brandTitle:` <div style="display: flex; align-items: center;">
    <svg
      width="36"
      height="45"
      viewBox="0 0 36 45"
