...
export function DeprecatedTokenGrid<T>({caption, children, headings, rows}: TokenGridProps<T>) {
  return (
...
DeprecatedTokenGrid.RowItem = TokenGridRowItem;
DeprecatedTokenGrid.Sample = TokenGridSample;
DeprecatedTokenGrid.Swatch = TokenGridSwatch;
DeprecatedTokenGrid.MonospaceLabel = TokenGridMonospaceLabel;
