...
<DownloadLLMFile
  rawFileLink="https://raw.githubusercontent.com/Workday/canvas-tokens/master/packages/canvas-tokens-docs/llm-txt/llm-token-migration-3.0.0.txt"
...
<NavCard
  ...
  link="https://workday.github.io/canvas-tokens/?path=/docs/docs-base-tokens--docs#color"
/>
...
<NavCard
  title="New palette colors"
  link="https://workday.github.io/canvas-tokens/?path=/docs/docs-base-tokens--docs"
/>
