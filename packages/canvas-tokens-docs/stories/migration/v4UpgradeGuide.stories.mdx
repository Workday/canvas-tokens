...
Canvas Tokens v4 introduces significant updates to align with our Workday X Sana integration,
...
semantics. All deprecated tokens point directly to their replacement values:
...
> Important: The `system.color.border.inverse` token is a breaking change and will have to be
> updated to **Important** This is a breaking change. Teams will have to update their code to use
