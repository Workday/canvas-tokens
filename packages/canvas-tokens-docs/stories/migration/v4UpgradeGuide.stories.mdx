...
| `system.color.bg.alt.stronger` | `system.color.surface.alt.default` with overlay (`system.color..default`)                      |
...
| `system.color.icon.positive.soft`     | `system.color..default`                                                            |
...
| `system.color.icon.critical.soft`     | `system.color.fg.danger.default`                                                   |
| `system.color.icon.critical.softer`   | `system.color.fg.danger.default`                                                   |
