...
import banner from '../images/v4-banner.png';
...
<AnnouncementBanner
  ...
  linkText="View Upgrade Guide v4"
/>
...
**Note:** These should only be imported once at the root level of an application to ensure global theming.
