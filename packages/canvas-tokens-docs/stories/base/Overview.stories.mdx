...
import {BaseFontSize} from './examples/BaseFontSize';
import {NavCard} from '../../components/NavCard';

<Meta title="Docs/Base Tokens/Overview" />
...
Default fontSize for the browser, may be overriden by user preferences
