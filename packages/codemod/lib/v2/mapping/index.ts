...
export const systemColors = {
  ...
  'border,borderColor,borderTopColor,borderRightColor,borderBottomColor,borderLeftColor,borderInlineColor,borderBlockColor,borderInlineStartColor,borderInlineEndColor,borderBlockStartColor,borderBlockEndColor':
    {
  ...
  static: {
    blackPepper600: 'system.color.static.black',
    blueberry100: 'system.color.static.blue.soft',
    blueberry400: 'system.color.static.blue.default',
    blueberry500: 'system.color.static.blue.strong',
    cantaloupe100: 'system.color.static.orange.soft',
    cantaloupe400: 'system.color.static.orange.default',
    cantaloupe600: 'system.color.static.orange.strong',
    cinnamon100: 'system.color.static.red.soft',
    cinnamon500: 'system.color.static.red.default',
    cinnamon600: 'system.color.static.red.strong',
    frenchVanilla100: 'system.color.static.white',
    greenApple100: 'system.color.static.green.soft',
    greenApple400: 'system.color.static.green.default',
    greenApple600: 'system.color.static.green.strong',
    licorice300: 'system.color.static.gray.default',
    licorice400: 'system.color.static.gray.strong',
    licorice500: 'system.color.static.gray.stronger',
    soap300: 'system.color.static.gray.soft',
    toastedMarshmallow600: 'system.color.static.gold.stronger',
  },
};
