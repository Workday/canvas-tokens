import{j as n,a as t,F as i}from"./jsx-runtime-CJPOobNs.js";import{M as a,U as c}from"./index-2WM9CWcf.js";import"./index-DdDtHz5p.js";import{useMDXComponents as s}from"./index-DoV7cT2f.js";import"./index-ChsGqxH_.js";import"./iframe-Dzh_dVr4.js";import"../sb-preview/runtime.js";import"./chunk-6E673XPF-B8Arh_2W.js";import"./index-QF83YFrf.js";import"./index-BRq5TIsn.js";import"./index-DyTWsQK6.js";import"./index-DrFu-skq.js";function o(r){const e=Object.assign({h1:"h1",h2:"h2",ul:"ul",li:"li",a:"a",p:"p",ol:"ol",code:"code",h3:"h3",table:"table",thead:"thead",tr:"tr",th:"th",tbody:"tbody",td:"td",h4:"h4",pre:"pre"},s(),r.components);return t(i,{children:[n(a,{title:"Maintaining/Style Dictionary/Formatters"}),`
...
`,n(e.li,{children:n(e.a,{href:"#tokens-info-formatters",children:"Tokens Info Formatters"})}),`
`]}),`
`]}),`
...
// output
\`$cnvs-sys-depth-1: 0 4px 16px rgba(0, 0, 0, 0.1); // Small shadow\`
`})}),n(e.h2,{id:"tokens-info-formatters",children:"Tokens Info Formatters"}),n(e.h4,{id:"jsontokens-info-export",children:"json/tokens-info-export"}),t(e.p,{children:["Located in ",n(e.code,{children:"formatTokensInfoExport"}),`. Outputs an array of objects with detailed information about
each token as prettified JSON.`]}),n(e.pre,{children:n(e.code,{className:"language-js",children:`// input
{
  allTokens: [
    {
      value: "#ffefee",
...
\`[
  {
    ...
    "level": "base",
    "value": "#ffefee",
    "computedValue": "#ffefee",
    "fallback": "#ffefee",
    "fallbackValue": undefined,
    "deprecatedComment": undefined
  }
]\`
`})}),n(e.h4,{id:"csvtokens-info-export",children:"csv/tokens-info-export"}),t(e.p,{children:["Located in ",n(e.code,{children:"formatTokensInfoExportCSV"}),`. Outputs a CSV file with one row per token and columns for
key metadata.`]}),n(e.pre,{children:n(e.code,{className:"language-js",children:`// input
{
  allTokens: [
    {
      value: "#ffefee",
...
// output
\`name,level,value,computedValue,fallback,fallbackValue,deprecatedComment
base.palette.cinnamon.100,base,#ffefee,#ffefee,#ffefee,,\`
`})})]})]})}function k(r={}){const{wrapper:e}=Object.assign({},s(),r.components);return e?n(e,Object.assign({},r,{children:n(o,r)})):o(r)}export{k as default};
