import{c as e}from"./chunk-6E673XPF-B8Arh_2W.js";const t="4.4.0-beta.0",o=e({base:"light",brandTitle:` <div style="display: flex; align-items: center;">
    <svg
      width="36"
      height="45"
      viewBox="0 0 36 45"
  ...
  </div>`,brandUrl:"https://github.com/Workday/canvas-kit",colorPrimary:"#0F2E66",colorSecondary:"#B03286",appBg:"#ffffff",textColor:"#2B2B2B",textInverseColor:"#ffffff",barTextColor:"#5D6775",barSelectedColor:"#0F2E66",barBg:"#ffffff"}),r={parameters:{chromatic:{disableSnapshot:!1},options:{storySort:{order:["Docs",["Getting Started","Contributing","Base Tokens","Brand Tokens","System Tokens",["Overview"],"Sana Theme"],"Guides",["Upgrade Guides","Migrations"],"Visual Tests",["Deprecated"]]}},docs:{theme:o}}};export{r as default};
