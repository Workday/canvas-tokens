...
these sparingly.`}),e(g,{}),e(a.hr,{})]})]})}function C(t={}){const{wrapper:a}=Object.assign({},c(),t.components);return a?e(a,{...t,children:e(s,{...t})}):s(t)}const x=()=>{throw new Error("Docs-only story")};x.parameters={docsOnly:!0};const o={title:"Docs/Base Tokens",tags:["stories-mdx"],includeStories:["__page"]};o.parameters=o.parameters||{};o.parameters.docs={...o.parameters.docs||{},page:C};const A=["__page"];export{A as __namedExportsOrder,x as __page,o as default};
//# sourceMappingURL=Base.stories-4bf2b75c.js.map
