import{c as e}from"./chunk-6P7RB4HF-36fee097.js";const t="3.1.4",s=e({base:"light",brandTitle:` <div style="display: flex; align-items: center;">
    <svg
      width="36"
      height="45"
      viewBox="0 0 36 45"
    ...
    <div style="display: flex; flex-direction: column; color: #0F2E66;">
      ...
      <span style="font-size: 18px; font-weight: 500;">v${t}</span>
    </div>
  </div>`,brandUrl:"https://github.com/Workday/canvas-kit",colorPrimary:"#0F2E66",colorSecondary:"#B03286",appBg:"#ffffff",textColor:"#2B2B2B",textInverseColor:"#ffffff",barTextColor:"#5D6775",barSelectedColor:"#0F2E66",barBg:"#ffffff"});const a={parameters:{chromatic:{disableSnapshot:!1},options:{storySort:{order:["Docs",["Getting Started","Contributing","Base Tokens","Brand Tokens","System Tokens",["Overview"]],"Guides",["Upgrade Guides","Migrations"],"Visual Tests"]}},docs:{theme:s}}};export{a as default};
//# sourceMappingURL=preview-a937fd49.js.map
