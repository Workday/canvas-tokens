import{j as n,a as r,F as t}from"./jsx-runtime-86dfebf6.js";import{M as o,U as s}from"./index-fe986cc6.js";import"./index-586dd939.js";import{u as i}from"./index-2ef8b458.js";import"./index-1b03fe98.js";import"./iframe-e0eb6041.js";import"../sb-preview/runtime.js";import"./chunk-6E673XPF-4294b5bd.js";import"./index-6fd5a17b.js";import"./index-d7bb098e.js";import"./index-356e4a49.js";function l(a){const e=Object.assign({h1:"h1",h2:"h2",ul:"ul",li:"li",a:"a",p:"p",code:"code",h3:"h3",pre:"pre"},i(),a.components);return r(t,{children:[n(o,{title:"Maintaining/Style Dictionary/Transformers"}),`
`,r(s,{children:[n(e.h1,{id:"transformers",children:"Transformers"}),n(e.h2,{id:"table-of-contents",children:"Table of Contents"}),r(e.ul,{children:[`
...
order and can be chained so one transform's result is used by the next.`]}),r(e.p,{children:[`| Transformer                   | Description                                                                |
| ----------------------------- | -------------------------------------------------------------------------- |
| `,n(e.code,{children:"name/camel"}),`                  | Converts token names from dot-path notation to camelCase for JS/TS output. |
| `,n(e.code,{children:"value/breakpoints/px"}),"        | Evaluates breakpoint expressions and appends the ",n(e.code,{children:"px"}),` unit.                |
| `,n(e.code,{children:"value/deprecated"}),`            | Replaces deprecated token values with their fallback values.               |
| `,n(e.code,{children:"value/flatten-border"}),`        | Flattens border object tokens into a single-line CSS string.               |
| `,n(e.code,{children:"value/flatten-oklch"}),`         | Flattens oklch color tokens and handles transparency.                      |
| `,n(e.code,{children:"value/font-weight/numbers"}),`   | Maps string font weight names to their numeric equivalents.                |
| `,n(e.code,{children:"value/hex-to-rgba"}),"           | Converts hex color values to ",n(e.code,{children:"rgba()"}),` CSS strings.                         |
| `,n(e.code,{children:"value/letter-spacing/px2rem"})," | Converts letter-spacing from pixel units to ",n(e.code,{children:"rem"}),`.                         |
| `,n(e.code,{children:"value/line-height/px2rem"}),"    | Converts pixel-based line-height values to ",n(e.code,{children:"rem"}),`.                          |
| `,n(e.code,{children:"value/math"}),`                  | Evaluates math expressions in token values.                                |
| `,n(e.code,{children:"value/opacity"}),`               | Converts opacity from 0–100 scale to 0–1 decimal.                          |
| `,n(e.code,{children:"value/shadow/flat-sys"}),`       | Flattens shadow objects into single-line CSS strings.                      |
| `,n(e.code,{children:"value/variables"}),`             | Generates CSS variable names from token paths.                             |
| `,n(e.code,{children:"value/wrapped-font-family"}),"   | Wraps font family names containing spaces in quotes.                       |"]}),n(e.p,{children:"Below is a detailed description and example of each transformer."}),n(e.h2,{id:"namecamel",children:"name/camel"}),r(e.p,{children:["The ",n(e.code,{children:"name/camel"}),` transformer converts token names from dot-path notation (e.g.,
