import{j as n,a as r,F as a}from"./jsx-runtime-86dfebf6.js";import{M as d,U as l}from"./index-fe986cc6.js";import{u as i}from"./index-2ef8b458.js";import"./index-1b03fe98.js";import"./iframe-e0eb6041.js";import"../sb-preview/runtime.js";import"./chunk-6E673XPF-4294b5bd.js";import"./index-6fd5a17b.js";import"./index-d7bb098e.js";import"./index-356e4a49.js";function t(o){const e=Object.assign({h1:"h1",h2:"h2",ul:"ul",li:"li",a:"a",p:"p",code:"code",blockquote:"blockquote",strong:"strong",br:"br",h3:"h3",pre:"pre",em:"em",ol:"ol"},i(),o.components);return r(a,{children:[n(d,{title:"Maintaining/Token JSON Structure"}),`
`,r(l,{children:[n(e.h1,{id:"token-json-structure",children:"Token JSON Structure"}),n(e.h2,{id:"table-of-contents",children:"Table of Contents"}),r(e.ul,{children:[`
...
`]}),n(e.h3,{id:"file-organization",children:"File Organization"}),r(e.p,{children:[`| Category          | Location                          | Description                                                                                 |
| ----------------- | --------------------------------- | ------------------------------------------------------------------------------------------- |
| Base              | `,n(e.code,{children:"tokens/base.json"}),`                | Foundation tokens (color, spacing, etc.).                                                   |
| Brand             | `,n(e.code,{children:"tokens/web/brand.json"}),`           | Brand/tenant-level overrides and references.                                                |
| Deprecated Base   | `,n(e.code,{children:"tokens/web/deprecated/base.json"}),` | Deprecated Foundation tokens (color, spacing, etc.).                                        |
| Deprecated Brand  | `,n(e.code,{children:"tokens/web/deprecated/brand/*"}),`   | Deprecated brand/tenant-level overrides and references.                                     |
| Deprecated System | `,n(e.code,{children:"tokens/web/deprecated/sys/*"}),`     | Deprecated system-level composite and component-aligned tokens (shadows, typography, etc.). |
| System            | `,n(e.code,{children:"tokens/web/sys.json"}),"             | System-level composite and component-aligned tokens (shadows, typography, etc.).            |"]}),n(e.h2,{id:"example-structure",children:"Example Structure"}),r(e.p,{children:["Below is an example of the structure for a base color token in ",n(e.code,{children:"tokens/base.json"}),"."]}),n(e.pre,{children:n(e.code,{className:"language-json",children:`{
  "base": {
    "palette": {
      "amber": {
        "25": {
...
`})}),n(e.h3,{id:"key-fields",children:"Key Fields"}),r(e.p,{children:["All tokens have a ",n(e.code,{children:"value"})," and ",n(e.code,{children:"type"})," field, and optionally have a ",n(e.code,{children:"description"})," field."]}),r(e.p,{children:[`| Field         | Description                                                                       |
| ------------- | --------------------------------------------------------------------------------- |
| `,n(e.code,{children:"value"}),`       | The token's primitive or referenced value (hex, rgba, a reference string, etc.).  |
| `,n(e.code,{children:"type"}),"        | The category/type (e.g., ",n(e.code,{children:"color"}),", ",n(e.code,{children:"dimension"}),", ",n(e.code,{children:"shadow"}),`).                         |
| `,n(e.code,{children:"description"})," | Human-readable documentation for the token. Used to generate JSDocs. ",n(e.em,{children:"(optional)"})," |"]}),n(e.h3,{id:"token-references",children:"Token References"}),r(e.p,{children:["Tokens can reference other tokens using the ",n(e.code,{children:"{path.to.token}"})," syntax. For example:"]}),n(e.pre,{children:n(e.code,{className:"language-json",children:`{
  "brand": {
    "primary": {
      "base": {
...
the following deprecated-specific fields:`]}),r(e.p,{children:[`| Field               | Description                                                             |
| ------------------- | ----------------------------------------------------------------------- |
| `,n(e.code,{children:"deprecated"}),`        | Boolean indicating the token is deprecated.                             |
| `,n(e.code,{children:"deprecatedComment"}),` | An explanation for why the token was deprecated.                        |
| `,n(e.code,{children:"fallback"}),"          | Specifies a fallback token/path to use instead of the deprecated token. |"]}),n(e.h3,{id:"example-structure-1",children:"Example Structure"}),n(e.p,{children:"Below is an example structure of a deprecated token:"}),n(e.pre,{children:n(e.code,{className:"language-json",children:`{
  "color": {
    "background": {
      "brand": {
        "value": "{base.palette.blue.400}",
...
`})})]})]})}function b(o={}){const{wrapper:e}=Object.assign({},i(),o.components);return e?n(e,Object.assign({},o,{children:n(t,o)})):t(o)}export{b as default};
