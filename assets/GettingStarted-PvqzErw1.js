import{a as s,j as n,F as c}from"./jsx-runtime-CJPOobNs.js";import{M as d,U as l}from"./index-2WM9CWcf.js";import{useMDXComponents as i}from"./index-DoV7cT2f.js";import"./index-ChsGqxH_.js";import"./iframe-Dzh_dVr4.js";import"../sb-preview/runtime.js";import"./chunk-6E673XPF-B8Arh_2W.js";import"./index-QF83YFrf.js";import"./index-BRq5TIsn.js";import"./index-DyTWsQK6.js";import"./index-DrFu-skq.js";const r=({img:a,link:e,linkText:t})=>s("a",{href:e,className:"announcement-banner","aria-label":t,children:[n("img",{alt:t,src:a,width:"100%"}),n("span",{className:"cnvs-sys-type-subtext-large",children:t})]});try{r.displayName="AnnouncementBanner",r.__docgenInfo={description:"",displayName:"AnnouncementBanner",props:{img:{defaultValue:null,description:"",name:"img",required:!0,type:{name:"any"}},link:{defaultValue:null,description:"",name:"link",required:!0,type:{name:"any"}},linkText:{defaultValue:null,description:"",name:"linkText",required:!0,type:{name:"any"}}}}}catch{}const p=""+new URL("v4-banner-fF92hr8_.png",import.meta.url).href;function o(a){const e=Object.assign({h1:"h1",h2:"h2",p:"p",blockquote:"blockquote",strong:"strong",code:"code",a:"a",h3:"h3",pre:"pre",h4:"h4"},i(),a.components);return s(c,{children:[n(d,{title:"Docs/Getting Started"}),`
`,s(l,{children:[n(e.h1,{id:"canvas-tokens-web",children:"Canvas Tokens Web"}),n(r,{img:p,link:"https://workday.github.io/canvas-tokens/?path=/docs/guides-upgrade-guides-v4-overview--docs",linkText:"View Upgrade Guide v4"}),n(e.h2,{id:"getting-started",children:"Getting Started"}),n(e.p,{children:`Canvas design tokens are used throughout our Canvas components. Whether you're using them directly
...
`})}),s(e.p,{children:[n(e.strong,{children:"Note:"})," These should only be imported once at the root level of an application to ensure global theming."]}),n(e.pre,{children:n(e.code,{className:"language-ts",children:`// index.ts
import '@workday/canvas-tokens-web/css/base/_variables.css';
import '@workday/canvas-tokens-web/css/system/_variables.css';
import '@workday/canvas-tokens-web/css/brand/_variables.css';
...
import '@workday/canvas-tokens-web/css/system/_variables.css';
import '@workday/canvas-tokens-web/css/brand/_variables.css';
`})})]})]})}function _(a={}){const{wrapper:e}=Object.assign({},i(),a.components);return e?n(e,Object.assign({},a,{children:n(o,a)})):o(a)}export{_ as default};
